...
class RequestUtil{
     ...
     * 一般的get请求或post请求
     */
    RequestUtil(String method,String url, Map<String, String> paramsMap, Map<String, String> headerMap, HiCallback callBack) {
        switch (method){
            case "GET":
     ...
     * post请求，传递json格式数据。
     */
    RequestUtil(String url, String jsonStr, Map<String, String> headerMap, HiCallback callBack) {
     ...
     * 上传文件
     */
    RequestUtil(String url, File file ,List<File> fileList,Map<String,File> fileMap,String fileKey,String fileType, Map<String,String> paramsMap, Map<String, String> headerMap,HiCallback callBack) {
     ...
     * get请求
     */
    private void urlHttpGet(final String url, final Map<String, String> paramsMap, final Map<String, String> headerMap, final HiCallback callBack) {
     ...
     * post请求
     */
    private void urlHttpPost(final String url, final Map<String, String> paramsMap, final String jsonStr, final Map<String, String> headerMap, final HiCallback callBack) {
        mThread = new Thread(new Runnable() {
            @Override
            public void run() {
     ...
     * 上传文件
     */
    private void urlHttpUploadFile(final String url, final File file , final List<File> fileList, final Map<String,File> fileMap, final String fileKey, final String fileType, final Map<String,String> paramsMap, final Map<String, String> headerMap, final HiCallback callBack) {
        mThread = new Thread(new Runnable() {
            @Override
            public void run() {
