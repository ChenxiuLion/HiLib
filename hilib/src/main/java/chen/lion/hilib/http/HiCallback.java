...
public abstract class HiCallback<T> {
    ...
    public static abstract class ToDefault extends HiCallback<RealResponse> {
        @Override
    ...
    public static abstract class ToString extends HiCallback<String> {
        @Override
    ...
    public static abstract class ToBitmap extends HiCallback<Bitmap> {
        ...
        public ToBitmap(int targetWidth, int targetHeight) {
        ...
        public ToBitmap(ImageView imageView) {
     ...
     * 下载文件时的回调类
     */
    public static abstract class ToFile extends HiCallback<File> {
         ...
         */
        public ToFile(String destFileDir, String destFileName) {
